...
- `cimmich-v1.1.0-community-preview.1.tar.gz`,
  `cimmich-v1.1.0-community-preview.1.zip` and `SHA256SUMS` from that directory;
...
`v1.1.0-community-preview.1` at the exact merged candidate commit. If the merge
