...
Current candidate: `v1.1.0-community-preview.23` for exact Immich 3.1.0
...
create no inferred relationship truth. Community Preview 23 keeps Discover and
...
- one-archive checksum acceptance and guided database-backup Compose rendering;
...
automatically until unresolved work or the end of the explicit top-500 queue is
reached, including after the last visible card is confirmed. Queue badges expose
the ready count while one bounded Smart Search counts that queue, then show exact
...
Community Preview 18 remains immutable at schema 142. Community Preview 23 is
