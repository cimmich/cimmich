...
The current maintained release is `v1.1.0-community-preview.8` on schema
128/patch 1. Later preview numbers must never move or replace an existing tag.
...
`v1.1.0-community-preview.8` means the exact current self-contained Community
