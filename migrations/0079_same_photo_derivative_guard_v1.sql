...
IS 'Conservative audit-only independence guard for exact files, exact export metadata, or multi-face geometry-preserving derivatives in one governed embedding space.';
