...
class AssetViewerManager extends BaseEventManager<Events> {
  ...
  isShowCimmichOverlay = $state(true);
  ...
  get detailPanelTarget() {
    return this.#detailPanelTarget;
  }
  ...
  toggleCimmichOverlay() {
    this.isShowCimmichOverlay = !this.isShowCimmichOverlay;
    if (this.isShowCimmichOverlay) {
      this.closeDetailPanel();
  ...
  openCimmichPanel() {
    ...
    this.#detailPanelTarget = 'cimmich';
  }

  clearDetailPanelTarget(target?: DetailPanelTarget) {
    if (!target || this.#detailPanelTarget === target) {
      this.#detailPanelTarget = null;
    }
  }
