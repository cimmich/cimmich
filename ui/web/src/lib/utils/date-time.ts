...
/**
 * Preserve the calendar day in the supplied zone for APIs that accept an ISO date,
 * rather than shifting local wall time into a future UTC datetime.
 */
export const asLocalDateISO = (date: DateTime<true>) => date.toISODate();
