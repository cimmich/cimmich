...
describe('getAltText', () => {
  ...
  it.each`
    ...
    ${false} | ${undefined} | ${undefined} | ${[{ name: '' }]}                                     | ${'Image taken on January 1, 2024'}
    ${false} | ${undefined} | ${undefined} | ${[{ name: '' }, { name: 'person1' }, { name: ' ' }]} | ${'Image taken with person1 on January 1, 2024'}
  `(
